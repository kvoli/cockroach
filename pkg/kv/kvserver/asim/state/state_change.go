...
type Change interface {
	...
	Apply(s State)
	// To returns the recepient of any added data for a change.
	To() StoreID
...
type Changer interface {
	...
	// Tick updates state changer to apply any changes that have ocurred
...
func (sc *replicaChanger) Push(tick time.Time, change Change) (time.Time, bool) {
	...
	// the last completion timestamp + delay. Otherwise, there is no queueing
