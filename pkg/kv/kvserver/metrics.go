...
var (
	...
	metaAverageRuntimeCPUNanosPerSecond = metric.Metadata{
		Name:        "rebalancing.runtime_cpunanospersecond",
		Help:        "Average CPU nanoseconds used in the last 5 minutes.",
		Measurement: "Nanoseconds/Sec",
		Unit:        metric.Unit_NANOSECONDS,
	}
...
type StoreMetrics struct {
	...
	*split.LoadSplitterMetrics
	...
	AverageRuntimeCPUNanosPerSecond *metric.GaugeFloat64
...
func newStoreMetrics(histogramWindow time.Duration) *StoreMetrics {
	...
	sm := &StoreMetrics{
		...
		AverageRuntimeCPUNanosPerSecond: metric.NewGaugeFloat64(metaAverageRuntimeCPUNanosPerSecond),
